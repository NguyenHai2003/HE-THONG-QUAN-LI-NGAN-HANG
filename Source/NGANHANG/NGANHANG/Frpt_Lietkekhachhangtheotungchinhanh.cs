...
namespace NGANHANG
{
    public partial class Frpt_Lietkekhachhangtheotungchinhanh : DevExpress.XtraEditors.XtraForm
    {
        ...
        {
            if (cbChiNhanh.Text.Trim() == "Tất cả chi nhánh")
            {
                macn = "TATCA";
            }
            else
        ...
        private void btnXuat_Click(object sender, EventArgs e)
        {
            ...
            if (cbChiNhanh.Text.Trim() == "Tất cả chi nhánh")
            {
                report.lblTieude.Text = "DANH SÁCH KHÁCH HÀNG CỦA " + cbChiNhanh.Text.ToUpper();
            }
            else
            {
                report.lblTieude.Text = "DANH SÁCH KHÁCH HÀNG CỦA CHI NHÁNH " + cbChiNhanh.Text.ToUpper();
            }
