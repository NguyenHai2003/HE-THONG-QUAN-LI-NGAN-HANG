...
namespace NGANHANG
{
    public partial class frmNhanVien : Form
    {
        ...
        private void btnXoa_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                MessageBox.Show("Không thể xóa nhân viên thuộc nhóm ngân hàng!");
                bdsNV.Position = vitri;
                return;
            }
            if (Program.ExecSqlKiemTra1("SP_KIEMTRAGIAODICHNHANVIEN", txtMaNV.Text) == 1)
            {
                MessageBox.Show("Nhân viên đã thực hiện giao dịch!");
                return;
            }
        ...
        private void btnCCN_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (txtMaNV.Text.Replace(" ", "") == Program.maNV)
            {
                MessageBox.Show("Không thể chuyển bản thân.");
                bdsNV.Position = vitri;
                return;
            }
        ...
        private void btnThoat_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                DialogResult result = MessageBox.Show("Bạn có chắc thoát mà không lưu?", "Xác nhận", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
        ...
        private void btnXacNhan_Click_1(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Người dùng đã có tài khoản trên hệ thống!");
                return;
            }
            else
            {
