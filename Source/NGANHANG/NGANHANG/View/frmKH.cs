...
namespace NGANHANG.View
{
    public partial class frmKH : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnGhi_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            else if (valueSaved == 2)
            {
                    ...
                    !string.IsNullOrEmpty(txtDIACHI.Text))
                {
                    ...
                    {
                        MessageBox.Show("Đã xảy ra lỗi khi hiệu chỉnh khách hàng: " + ex.Message, "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                    finally
                    {
                        Program.conn.Close();
        ...
        private void btnPhucHoi_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                MessageBox.Show("Đã xảy ra lỗi khi phục hồi khách hàng: " + ex.Message, "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            finally
            {
                Program.conn.Close();
