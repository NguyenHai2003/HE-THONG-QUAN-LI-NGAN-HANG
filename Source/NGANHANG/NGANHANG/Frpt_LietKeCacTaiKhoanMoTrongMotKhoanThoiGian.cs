...
namespace NGANHANG
{
    public partial class Frpt_LietKeCacTaiKhoanMoTrongMotKhoanThoiGian : Form
    {
        ...
        private void btnXembaocao_Click(object sender, EventArgs e)
        {
            ...
            string maCN = "";
            string tieuDe = "";
            if (cbChiNhanh.Text.Trim() == "Tất cả")
            {
                maCN = "HAICN";
                tieuDe = "TÀI KHOẢN ĐƯỢC MỞ TẠI TẤT CẢ CHI NHÁNH";
            }
            else
            {
                maCN = ComboBoxHelper.timMaCN((cbChiNhanh.Text.Trim()));
                tieuDe = "TÀI KHOẢN ĐƯỢC MỞ TẠI CHI NHÁNH " + cbChiNhanh.Text.ToUpper(); ;
            }
